...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement->execute(array(
										$_POST['p_name'],
										$_POST['p_old_price'] = "12",
										$_POST['p_current_price'],
										$_POST['p_qty'] = "1",
										$final_name,
										$_POST['p_description'],
										$_POST['p_short_description'] = "none",
										$_POST['p_feature'] = "1",
										$_POST['p_condition']= "unknown",
										$_POST['p_return_policy'] = "unknown",
										0,
										$_POST['p_is_featured'] = "1",
										$_POST['p_is_active'] = "1",
										$_POST['ecat_id'] = "21"
									));
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">VIN<span>*</span><br></label>
							<div class="col-sm-4">
