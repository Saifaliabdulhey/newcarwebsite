...
<?php
if(!isset($_REQUEST['p_current_price'])) {
    header('location: index.php');
    exit;
} else {
    // Check the id is valid or not
    $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_current_price=?");
...
$statement->execute(array($p_total_view,$_REQUEST['p_current_price']));
					...
					<div class="row">
						<div style="width:80%; margin:80px;">
							<ul class="prod-slider">
								...
								<li style="background-image: url(assets/uploads/<?php echo $p_featured_photo; ?>); height:800px;">
                                    <a style="height:800px;" class="popup" href="assets/uploads/<?php echo $p_featured_photo; ?>"></a>
								</li>
                                <?php
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <li style="background-image: url(assets/uploads/product_photos/<?php echo $row['photo']; ?>); height:800px;
                                    ">
							...
							<div id="prod-pager">
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <a data-slide-index="<?php echo $i; ?>" href=""><div class="prod-pager-thumb" style="margin:10px;;background-image: url(assets/uploads/product_photos/<?php echo $row['photo']; ?>"></div></a>
                                    <?php
                                    $i++;
                                }
                                ?>
